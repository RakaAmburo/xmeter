...
public class AddAction__ {

    private Boolean enabled;
    private List<String> disabledReasons = new ArrayList<String>();
    private List<MissingCategory_> missingCategories = new ArrayList<MissingCategory_>();
     ...
     */
    public List<MissingCategory_> getMissingCategories() {
     ...
     *     The missingCategories
     */
    public void setMissingCategories(List<MissingCategory_> missingCategories) {
