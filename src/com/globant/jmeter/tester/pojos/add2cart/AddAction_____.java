...
public class AddAction_____ {

    private Boolean enabled;
    private List<String> disabledReasons = new ArrayList<String>();
    private List<MissingCategory___> missingCategories = new ArrayList<MissingCategory___>();
     ...
     */
    public List<MissingCategory___> getMissingCategories() {
     ...
     *     The missingCategories
     */
    public void setMissingCategories(List<MissingCategory___> missingCategories) {
