...
public class AddAction_ {

    private Boolean enabled;
    private List<String> disabledReasons = new ArrayList<String>();
    private List<MissingCategory> missingCategories = new ArrayList<MissingCategory>();
     ...
     */
    public List<MissingCategory> getMissingCategories() {
     ...
     *     The missingCategories
     */
    public void setMissingCategories(List<MissingCategory> missingCategories) {
